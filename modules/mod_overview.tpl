...
{if $modMap}
	{bitmodule title="$moduleTitle" name="overview" class="mapper-module"}
		...
		{* height is just a starting fallback - html/form.html resizes this
		   ...
		   mapper/CLAUDE.md) and isn't fixed across mapsets *}
		<iframe class="FormFrame" id="FormFrame" name="FormFrame" src="{$smarty.const.MAPPER_PKG_URL}html/form_blank.html" scrolling="auto" style="width:100%; height:120px" frameborder="0">
		</iframe>
	{/bitmodule}
{/if}
{/strip}